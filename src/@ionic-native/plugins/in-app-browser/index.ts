...
export interface InAppBrowserResizeOptions {
  /** Width of the InAppBrowser window. */
  width?: number;
  /** Height of the InAppBrowser window. */
  height?: number;
}

export interface InAppBrowserOptions extends InAppBrowserResizeOptions {
...
export class InAppBrowserObject {
  ...
  /**
   * Resizes an InAppBrowser window.
   */
  @CordovaInstance()
  resize(options: InAppBrowserResizeOptions): void {}
